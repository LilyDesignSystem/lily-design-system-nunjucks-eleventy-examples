...
│   │   └── components.js                  ← catalog inventory (407 entries)
│   ├── _includes/
│   │   └── layouts/
...
│   ├── components/{kebab-case}.njk        ← one file per canonical slug (407)
...
- [ ] `/components/{slug}/` exists for all 407 canonical slugs with a live
      demo.
- [ ] All 12 composed-page demos exist.

### 9.2 Macro coverage

- [ ] All 407 canonical components have a `src/components/{kebab-case}.njk`
